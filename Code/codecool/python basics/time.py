...
class Person:
    ...
    def loose_hp(self, number):
        self.hp -= number
        print(Person.name + " looses " + str(number) +
              "health. Now at %s health" % (self.hp))
...
class Monster:
    ...
    def loose_hp(self, number):
        ...
        self.hp -= number
        print("Monster looses " + str(number) +
              " health. Currently at : " + str(self.hp) + " health")
